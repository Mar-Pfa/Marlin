...
#define STRING_CONFIG_H_AUTHOR "(Primes Delta)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Prime Delta"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 401 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 293 // mm //158

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 49 // mm 

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 65 // mm  
...
#define AUTOCALIBRATION_PRECISION 0.08 // mm -- prime modified from 0.03
...
#define MANUAL_Z_HOME_POS 233.8  // For delta: Distance between nozzle and print surface after homing.

//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
#define HOMING_FEEDRATE {80*60, 80*60, 80*60, 0}  // set the homing speeds (mm/min) Prime override

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {51.3833, 51.3833, 51.3833, 372}
#define DEFAULT_MAX_FEEDRATE          {200, 200, 200, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {400,400,400,2500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
